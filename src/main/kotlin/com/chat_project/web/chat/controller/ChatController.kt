...
class ChatController(
    ...
    @Operation(method = "MESSAGE", summary = "메세지 입력")
    fun message(chatRoomDTO: ChatRoomDTO, @AuthenticationPrincipal user: User) {
        val member: Member? = memberRepository.findByEmail(user.username)
        chatService.sendMessage(chatRoomDTO, member)
    }
